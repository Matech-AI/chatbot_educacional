...
class DriveHandler:
    ...
    def authenticate(self, credentials_path: str = 'data/credentials.json', api_key: str = None) -> bool:
        ...
        auth_methods = [
            # Service Account / OAuth2 via credentials file (preferred for web servers)
    ...
    def _get_extension_from_mime_type(self, mime_type: str) -> str:
        ...
        # Fallback: detect .md by extension when mime type is generic text/plain
        result = mime_to_ext.get(mime_type, '')
        return result
